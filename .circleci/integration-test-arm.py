...
def enable_qemu():
    """
    Enable qemu to allow arm images to be run.
    """
...
def main():
    ...
    subparsers.add_parser('enable-qemu')
    ...
    image_name = 'tljh-systemd-arm'
    container_name = 'tljh-ci-run-arm'
